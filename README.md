...
1) Handling Missing Values:										
	• Check for missing values in the 'Price' column. How would you handle products with missing price information?				Ans:replacing values with imputation.For numerical data use mean,mode or median.Here we use median because data set contains outlier values				
